...
本文不可能把每一个点都能写到，如果真要一个点一个点的写，可能得写1w+字吧。再说时隔两个多月没碰这个项目了，多多少少都忘了一些。我尽可能把当时在写这个项目遇到的各种坑写详细。如果在看本文或者demo的时候有不明白的地方可以在Github上面提[issue](https://github.com/CYBoys/Timi/issues/new)或者简书简信我也可以。bbbb
